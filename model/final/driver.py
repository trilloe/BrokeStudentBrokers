from logic import filter_RSI, get_data_month, place_order, alpaca_connection , calculate_RSI
...
for user in user_references:
    ...
    try:
        ...
        if doc_dict['botState'] == True:
            ...
            # TODO : Retrive balance from alpaca and shift inside loop
            ...
            for position in portfolio:
                if position.symbol in to_sell:
                    place_order(api,position.symbol, side='sell', qty=position.qty)
