...
while (i < len(tickers)) and (Amount_of_API_Calls < 1800):
    try:
        ...
        Hist_data.to_csv(r'history/'+stock+'.csv')  # Saves the historical data in csv format for further processing later
...
for stock in list_files:
    ...
    df.to_csv(r"rsi/"+Company+"_RSI.csv", index = False)